# Position Predictor — Results: football RB v2

_**RB v2** · rb-v3 @ e9b2ee8-dirty_
...
- **Experiment wall-clock:** 273.2s (total model fit time 198.4s across the grid)
...
|---|---|---|---|---|---|---|---|
| xgboost | val_weighted | 19.51 | 2380 | 80 | 0.752 | 0.53 | 0.04 |
| xgboost | mean | 8.70 | 2380 | 80 | 0.751 | 0.53 | 0.09 |
| ridge | recency_weighted | 0.10 | 2380 | 80 | 0.749 | 0.62 | 7.66 |
| elasticnet | recency_weighted | 0.10 | 2380 | 80 | 0.749 | 0.58 | 7.25 |
| lasso | recency_weighted | 0.11 | 2380 | 80 | 0.748 | 0.58 | 7.12 |
| ridge | mean | 0.10 | 2380 | 80 | 0.747 | 0.63 | 7.39 |
| ridge | val_weighted | 0.22 | 2380 | 80 | 0.747 | 0.63 | 3.42 |
| elasticnet | val_weighted | 0.21 | 2380 | 80 | 0.747 | 0.60 | 3.58 |
| elasticnet | mean | 0.13 | 2380 | 80 | 0.746 | 0.60 | 5.92 |
| lightgbm | mean | 5.62 | 2380 | 80 | 0.746 | 0.50 | 0.13 |
| xgboost | recency_weighted | 8.51 | 2380 | 80 | 0.746 | 0.50 | 0.09 |
| lightgbm | val_weighted | 11.07 | 2380 | 80 | 0.745 | 0.50 | 0.07 |
| lasso | mean | 0.15 | 2380 | 80 | 0.745 | 0.62 | 5.01 |
| lasso | val_weighted | 0.22 | 2380 | 80 | 0.744 | 0.62 | 3.44 |
| random_forest | val_weighted | 7.15 | 2380 | 80 | 0.742 | 0.53 | 0.10 |
| random_forest | mean | 4.08 | 2380 | 80 | 0.742 | 0.53 | 0.18 |
| random_forest | recency_weighted | 3.88 | 2380 | 80 | 0.738 | 0.53 | 0.19 |
| lightgbm | recency_weighted | 4.06 | 2380 | 80 | 0.737 | 0.53 | 0.18 |
