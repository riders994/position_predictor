...
_Scoring: **half ppr**. Model-only (ECR/ADP are benchmarks, never inputs). A handcuff's **contingent upside** = (starter − backup projected PPG) × the starter's projected miss share._
