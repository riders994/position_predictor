...
Runs the three steps a redraft user wants for the upcoming season:
  ...
  (c) project the season -> top 20 QB / 50 RB / 75 WR (returning players within each top-N).
...
Usage:
    ...
    uv run python scripts/redraft.py --top-qb 24 --top-rb 60 --top-wr 90
"""
...
def main() -> int:
    ...
    top_n = {"QB": args.top_qb, "RB": args.top_rb, "WR": args.top_wr}
